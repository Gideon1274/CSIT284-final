...
import com.example.pocketpal.data.ItemListAdapter;
import com.example.pocketpal.data.utility.ImageUtility;
...
public class display extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.fab_add_new_item).setOnClickListener(v -> {
            Intent intent = new Intent(display.this, DetailsActivity.class);
